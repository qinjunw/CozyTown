...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.4，2026-09-12 |
| 状态 | 世界事件、有界决策和两人自主会面已接入；资源协作、持久化及多场景模型评测继续按地图迭代 |
| 用途 | 定义 Agent 世界的目标、需求、验收、实施依赖与研究依据，作为后续任务拆分和设计讨论的入口 |
| 本轮交付范围 | 用户授权继续下一阶段并使用真实测试密钥；第三轮实现 Ren 与 Sora 的邀约、未来活动预约、实际赴约、交谈和日程恢复，实施结果由票据记录 |
| 代码参照 | `207e42c4f5962154417d7315d179bde130504a12` 及调研时的工作区；存在未提交修改，该提交不是完整运行快照 |
| 证据方法 | 一手资料、源码审阅、固定客户端、HTTP 边界及 Unity 测试；第三轮另以真实模型完成一次两人场景，记录提供方用量、延迟与宿主实际结果 |
