...
| 本轮交付范围 | 明确默认世界服务与场景 Agent 对象的装配、借用和释放边界；保留现有局部装配，登记换绑失败及运行中重配的独立修复范围 |
| 代码参照 | 本轮审计冻结于 `6cbf604c6249f811e75a7b4202325cc1f99575fd`，未修改生产和测试代码；前次续谈实现为 `78d91d2bb91221697946be454b3893dada1c0ae7` |
| 证据方法 | 本轮隔离 PlayMode 22、EditMode 4 项复测通过，新增真实模型调用 0；所有权、静态发现与未覆盖路径见[生命周期核验](audits/npc-session-composition-2026-09-15.md)。前次完整 EditMode 852、PlayMode 196 项及四世界 18 次真实调用属于[续谈修复验证](verification/npc-conversation-turn-2026-09-14.md)，不算本轮重跑 |
