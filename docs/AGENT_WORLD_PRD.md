...
| 本轮交付范围 | 交付后的待发言轮次跨预算等待保留，在派发时重新采样完整请求；默认预算、旧候选检查与自由表达默认值保持原规则 |
| 代码参照 | 基线 `68832af00675ecf3388085bee379d46b3fa5947d`；实现与测试 `78d91d2bb91221697946be454b3893dada1c0ae7`；完整输入与结果见[续谈修复验证](verification/npc-conversation-turn-2026-09-14.md) |
| 证据方法 | 隔离 EditMode 852、PlayMode 196 项通过，6 项真实入口默认跳过；新四世界共 18 次真实调用，2 次交付交谈、2 次拒绝均恢复。真实批次未耗尽八次预算，等待恢复的因果证据来自受控 F/S 场景；详见[验证报告](verification/npc-conversation-turn-2026-09-14.md) |
