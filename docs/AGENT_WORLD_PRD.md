...
| 本轮交付范围 | 明确结构化候选的外层行动版本说明，完成新登记的 48 个固定真实样本；普通游戏仍默认自由表达 |
| 代码参照 | 版本说明冻结于 `96a208dbaac4a412789c662a371580b121da778a`；输入、标注与运行结果见[版本复测](verification/npc-expression-version-2026-09-14.md) |
| 证据方法 | 本轮 Python 60、Unity 编解码 64 项通过；8 个独立固定世界各运行 F/S 三次，共 48 次 v4-flash 调用；S 24/24 版本正确且产生宿主输出，回答有效性另行评分 |
| 未验证内容 | 移动中答复恢复后的真实交谈、长期可靠率、四人共同负载、长期角色差异及跨日持久化稳定性 |
