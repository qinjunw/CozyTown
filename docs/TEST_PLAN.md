...
- 当前状态：两个 EditMode 测试程序集包含 228 个用例，PlayMode 测试程序集包含 35 个用例；2026-09-02 库存感知商店投影切片后的全量 EditMode 结果为 `228/228`，2026-09-01 最近一次全量 PlayMode 结果为 `35/35`，均为 0 failed、0 skipped。
